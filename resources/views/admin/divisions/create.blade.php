...
<style>
    ...
    .form-control:focus {
        outline: none;
        border-color: #667eea;
        box-shadow: 0 0 0 6px rgba(102, 126, 234, 0.15), 0 10px 25px rgba(0,0,0,0.1);
            ...
            <div class="col-12">
                <div class="form-wizard">
                    ...
                    <div class="wizard-header">
                        ...
                        <p class="wizard-subtitle">Organize your products with precision and style</p>
                    </div>
                    ...
                    <form action="{{ route('admin.divisions.store') }}" method="POST" id="divisionForm">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="category_id">
                                        Parent Category <span class="required-indicator">*</span>
                                    </label>
                                    <select name="category_id" id="category_id" class="form-control @error('category_id') is-invalid @enderror" required>
                                        <option value="">🏷️ Select Parent Category</option>
                                    ...
                                    @enderror
                                    <div class="form-help">💡 Choose the category this division will belong to</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                           value="{{ old('name') }}" required placeholder="Enter a unique division name...">
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-help">✨ A descriptive and memorable name for this division</div>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="description">Optional Description</label>
                                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                              rows="4" placeholder="Describe what this division contains and its purpose...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-help">📝 Help others understand what products belong in this division</div>
                                </div>
                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="color-input-group">
                                        <input type="color" name="color" id="color" class="form-control @error('color') is-invalid @enderror"
                                               value="{{ old('color', '#667eea') }}" style="width: 100px; height: 60px; border-radius: 15px;">
                                    ...
                                    @error('color')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-help">🎨 Choose a color that represents this division</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @error('icon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-help">🎯 Font Awesome icon class (e.g., fas fa-folder, fas fa-box)</div>
                                </div>
                        ...
                        <div class="wizard-actions">
                            ...
                            <button type="submit" class="btn btn-primary" id="submitBtn">
                                <i class="fas fa-magic"></i> Create Division
                            </button>
                        </div>
                    </form>
                </div>
...
$(document).ready(function() {
    ...
    // Icon preview (if you want to show icon preview)
